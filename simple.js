...
async function main() {
  ...
  await page.goto("https://stackoverflow.com/users/10849787/ashish-prasad"); //opening Google page
  ...
  await page.waitForTimeout(5000); //wait 2000 ms before pressing enter so that the entire term is typed
